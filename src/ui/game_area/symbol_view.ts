...
export function createSymbolView(index: number, type: SymbolType, configs: GameLayerConfigs): SymbolView {
...
export function updateSymbolView(symbol:SymbolView,configs: GameLayerConfigs, type? : SymbolType ){
