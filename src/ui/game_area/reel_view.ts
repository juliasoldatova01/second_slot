...
import  {type SymbolType, type SymbolView, createSymbolView, SYMBOLS, updateSymbolView } from "./symbol_view";
...
export function createReelView(index: number,configs: GameLayerConfigs): ReelView{
...
export function updateReelView(
    reel: ReelView,
