...
import { updateTopPanel, type TopPanel } from "../ui/top_panel/create_top_panel";
import { renderPanel } from "../ui/top_panel/render_top_panel";
import { startSpin, startSpinAll } from "./reels_controller";

export function initializeGame(topTanel: TopPanel, gameArea: GameArea, bottomPanel:BottomPanel,dt:number){
